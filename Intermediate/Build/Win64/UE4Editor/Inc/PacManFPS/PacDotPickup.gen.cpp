...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_APacDotPickup()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_PointValue = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("PointValue"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(PointValue, APacDotPickup), 0x0020080000000005);
				...
				MetaData->SetValue(NewProp_PointValue, TEXT("BlueprintProtected"), TEXT("true"));
				MetaData->SetValue(NewProp_PointValue, TEXT("Category"), TEXT("Points"));
				MetaData->SetValue(NewProp_PointValue, TEXT("ModuleRelativePath"), TEXT("PacDotPickup.h"));
	...
	IMPLEMENT_CLASS(APacDotPickup, 4044297715);
